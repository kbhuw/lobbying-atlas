...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round33a-root-draft.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
hold={'411dadce4230d620','514b36f2f26ccbdc','77fa863fe9a581de','4d1458cd78200a28','bf53efddefc53f4f','34cb8b1807fed9df'}
for k,v in p.items():
...
assert len(p)==30
(r/'general-round33a-30-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
