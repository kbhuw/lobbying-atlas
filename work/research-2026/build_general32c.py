...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round32c-root-draft.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
hold={'2cd7a0ca65db0b37','b84a4d85946e3959','516bd55c85531ef5','7a2b6fc649b88c84','980d2efc0694d0f9'}
for k,v in p.items():
...
assert len(p)==30
(r/'general-round32c-30-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
