...
r=pathlib.Path('work/research-2026');rows=json.load(open(r/'general-round67-input.json'));exec((r/'check_general67_final.py').read_text().split('p=json.load(open(root/')[0]);dest=r/'round67-image-audit';dest.mkdir(exist_ok=True)
def fetch(iv):
