...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round32a-root-draft.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
hold={'845079aaa42780aa','2add3941d22f2b59','38bb8833027d85c0','3d0b44e30fceb933','8a2e6d6dd4d7d840','aefd9bc4b5243bb0','987558707464394c','e7709c506bde5ffb'}
for k,v in p.items():
...
assert len(p)==30
(r/'general-round32a-30-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
