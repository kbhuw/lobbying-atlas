...
r=pathlib.Path('work/research-2026');rows=json.load(open(r/'general-round62-input.json'));exec((r/'check_general62_final.py').read_text().split('p=json.load(open(root/')[0]);dest=r/'round62-image-audit';dest.mkdir(exist_ok=True)
def fetch(iv):
