...
picks={'d72bf5b04e1b7251':1,'8363a2e0df7bbd4c':1,'22b425a5d5788942':1,'7c2198303807f033':1,'ccfa09731928abd4':2,'0233a4b47db3060c':1,'81bc30a37a4dbe5a':1}
audit=[]
...
pathlib.Path('work/research-2026/college-scorecard/round2-branding-audit.json').write_text(json.dumps(audit,indent=2)+'\n');print(json.dumps(audit,indent=2))
