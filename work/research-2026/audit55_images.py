...
r=pathlib.Path('work/research-2026');rows=json.load(open(r/'general-round55-input.json'));exec((r/'check_general34a.py').read_text().split('p=json.load(open(root/')[0]);dest=r/'round55-image-audit';dest.mkdir(exist_ok=True)
def fetch(iv):
