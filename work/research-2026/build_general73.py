...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round73-root-draft.json'))
rows=json.load(open(r/'general-round73-input.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
allow={3,11,12,13,14,17,19,26,28,29,31,32,41,48,49,51,54,55,56,57,58,59,62,63,64,65,66,67,68,69,71,72,73,76,78,79,80,82,83,86,88,90,91,92,93,94,95,97,98,99}
...
assert len(p)==100
(r/'general-round73-100-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
