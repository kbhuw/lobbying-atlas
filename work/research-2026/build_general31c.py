...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round31c-root-draft.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
hold={'6140b35b7ca505cf','5160a0ff2eb5c04d','0d89458e1a9d3a87','60a0d078523beee9','d52260625be7e51d','ec7601e18f97d2fb','062b1ce368a5a986'}
for k,v in p.items():
...
assert len(p)==30
(r/'general-round31c-30-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
