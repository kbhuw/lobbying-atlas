...
r=pathlib.Path('work/research-2026');rows=json.load(open(r/'general-round115-input.json'));e={};p={}
e=json.load(open(r/'round115-root-incremental-evidence.json'))
...
(r/'general-round115-root-draft.json').write_text(json.dumps(p,indent=2)+'\n')
