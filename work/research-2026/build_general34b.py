...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round34b-root-draft.json'))
rows=json.load(open(r/'general-round34-b-input.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
allow={0,2,3,10,12,13,15,16,17,18,20,22,23,25,26,27,31,36,38,43,45,46,47,51,52,56,57,58,59,60,63,64,65,67,69,70,76,77,78,81,82,83,84,87,91,94,97}
...
assert len(p)==100
(r/'general-round34b-100-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
