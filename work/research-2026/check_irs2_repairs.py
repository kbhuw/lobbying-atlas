...
with concurrent.futures.ThreadPoolExecutor(max_workers=3) as ex:
 for x in ex.map(one, [("b4cf5ae86664d375", {"name":"Florida Tomato Exchange","website":"https://floridatomatoexchange.com/"}),("f7565533abd69e9d",{"name":"Finishing Trades Institute","website":"https://www.fti.edu/"})]): print(str(x)[:200])
