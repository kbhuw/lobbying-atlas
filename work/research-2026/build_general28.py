...
hold={'dd304b3fd4586505','316b29bbc805fd93','cc67e0a104c5c1ad','274e5aa422676e2b','a4c2d6d6c4b63ea5','f4dea54181885e19'}
for k,v in p.items():
...
assert len(p)==90
(r/'general-round28-90-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
