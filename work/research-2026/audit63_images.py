...
r=pathlib.Path('work/research-2026');rows=json.load(open(r/'general-round63-input.json'));exec((r/'check_general63_final.py').read_text().split('p=json.load(open(root/')[0]);dest=r/'round63-image-audit';dest.mkdir(exist_ok=True)
def fetch(iv):
