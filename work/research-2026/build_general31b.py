...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round31b-root-draft.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
hold={'ffad253050c90312','8725c4cb16c748cf','feb87e88573419e8','507b7548d306cbf3','5f8b978407f3eaf2','b7b2e29c3ff2e612','6453fda3154ec200'}
for k,v in p.items():
...
assert len(p)==30
(r/'general-round31b-30-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
