...
urls=['https://www.grayscale.com/','https://www.groupeseb.com/','https://www.grundfos.com/us','https://www.grvty.com/','https://greatamericanoutdoors.com/']
a=list(concurrent.futures.ThreadPoolExecutor(5).map(run,urls));(r/'featured111-assets.json').write_text(json.dumps(a,indent=2));print(json.dumps(a,indent=2))
