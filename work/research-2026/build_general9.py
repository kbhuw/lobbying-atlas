...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round9-90-draft.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
hold={'ad70d4cf21895c20','13dc7b311ce10e66','bbc13c78e9a1ebef','d6885c5bff920c81','6658413a51c018ed','1583b816fe93d969','8f2959b3985139dc','fa77edb12143c9b3'}
for k,v in p.items():
...
assert len(p)==90
(r/'general-round9-90-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
