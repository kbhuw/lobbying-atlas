...
r=pathlib.Path('work/research-2026');rows=json.load(open(r/'general-round144-input.json'));e={};p={}
e=json.load(open(r/'round144-root-incremental-evidence.json'))
...
(r/'general-round144-root-draft.json').write_text(json.dumps(p,indent=2)+'\n')
