...
urls=['https://heartlandwater.com/','https://sdcommunitypower.org/','https://helsing.ai/']
a=list(concurrent.futures.ThreadPoolExecutor(5).map(run,urls));(r/'featured113-assets.json').write_text(json.dumps(a,indent=2));print(json.dumps(a,indent=2))
