...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round30c-root-draft.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
hold={'0cdc589a8131be70','466924f6c8cf0e13','b559c3429d47796e'}
for k,v in p.items():
...
assert len(p)==30
(r/'general-round30c-30-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
