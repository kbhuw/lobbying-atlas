...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round32b-root-draft.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
hold={'90d02823316d6083','43b94ca6d6a0a277'}
for k,v in p.items():
...
assert len(p)==30
(r/'general-round32b-30-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
