...
for k,index in [('cb0a210994f4742a',1),('4feb2399fd1c7a79',1),('5b8b09173fe28484',5),('06b501808051f7ec',2),('ca5fce98fbf7356b',1)]:
 ...
 (cache/(k+'.json')).write_text(json.dumps(c,indent=2));print(k,'icon validated')
