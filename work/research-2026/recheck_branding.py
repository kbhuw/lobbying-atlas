...
p=json.load(open(root/"reviewed.json"))
for label in ["a","b","c"]:p.update(json.load(open(root/f"sec-round3-{label}-researched.json")))
ids=["5a6652fedd970007","09ea05c509633872","546c84323874bbae","cb5e8cf1d90cc58b","fb4a8038a0f2b513","47165c98ac7853ee","70ad169cd0ae7115","d1f6c467dc488a8a"]
with concurrent.futures.ThreadPoolExecutor(max_workers=6) as ex:
 for k,v in ex.map(one,[(k,p[k]) for k in ids]):print(k,v.get("logo_kind"),v.get("logo_url"),flush=True)
