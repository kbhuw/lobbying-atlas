...
urls=['https://www.massmutual.com/','https://corporate.mattel.com/','https://www.masimo.com/','https://www.mastercard.com/','https://www.mckinsey.com/','https://www.marriott.com/']
def scan(u):
 try:
...
json.dump(out,open('work/research-2026/logo74-candidates.json','w'),indent=2)
