...
R=pathlib.Path(__file__).resolve().parent;ROOT=R.parents[2];master=ROOT/'work/research-2026/reviewed.json';p=json.load(open(master));shutil.copyfile(master,R/'middle20-before.json');q=json.load(open(R/'matches.json'))[40:60];audit=[]
for item in q:
 i=item['id'];x=p[i];m=item['matches'][0];e=m['registration']
 if i in ['2add3941d22f2b59','8a2e6d6dd4d7d840','d428c7b7616de476','9ca0cdc55522b05f','6563e9be00be19b9','b0c148f07b9fd482']:
...
(R/'middle20-decisions.json').write_text(json.dumps(audit,indent=2,ensure_ascii=False)+'\n');print('14 additional identities confirmed;6 retained partial.')
