...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round30a-root-draft.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
hold={'de1c9cbc427accb3','046c31d4d337a1fb','b3c2d29c6b03754f'}
for k,v in p.items():
...
assert len(p)==30
(r/'general-round30a-30-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
