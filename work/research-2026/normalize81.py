...
r=pathlib.Path('work/research-2026');rows=json.load(open(r/'general-round81-input.json'));e={};p={}
e=json.load(open(r/'round81-root-incremental-evidence.json'))
...
(r/'general-round81-root-draft.json').write_text(json.dumps(p,indent=2)+'\n')
