...
urls=['https://nationalvmm.org/','https://www.neogen.com/','https://www.nestleusa.com/','https://www.nyu.edu/','https://www.nationwide.com/personal/about-us/']
def scan(u):
 try:
...
json.dump(out,open('work/research-2026/logo76-candidates.json','w'),indent=2)
