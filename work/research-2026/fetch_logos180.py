...
(r/'featured180-logo-candidates.json').write_text(json.dumps(out,indent=2));print(json.dumps([{**v,'candidates':[{**a,'url':a['url'][:250]} for a in v.get('candidates',[])]} for v in out],indent=2))
