...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round29c-root-draft.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
hold={'6f00612bc29b9b3e','1c649db611f6fbd6','4a59b791b4a00d9f'}
for k,v in p.items():
...
assert len(p)==30
(r/'general-round29c-30-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
