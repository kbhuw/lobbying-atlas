...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round76-root-draft.json'))
...
allow={1, 2, 3, 4, 5, 8, 9, 12, 13, 14, 15, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 31, 32, 40, 42, 44, 48, 49, 50, 52, 53, 54, 56, 57, 59, 61, 64, 66, 68, 70, 73, 75, 77, 82, 83, 84, 87, 88, 90, 91, 93, 95, 96, 97, 98, 99}
...
assert len(p)==100
(r/'general-round76-100-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
