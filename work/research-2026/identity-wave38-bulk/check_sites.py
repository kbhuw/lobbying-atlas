...
previous={x['id'] for batch in ['identity-wave30-bulk','identity-wave31-bulk','identity-wave32-bulk','identity-wave33-bulk','identity-wave34-bulk','identity-wave35-bulk','identity-wave36-bulk','identity-wave37-bulk'] for x in json.load(open(ROOT/'work/research-2026'/batch/'queue.json'))}
