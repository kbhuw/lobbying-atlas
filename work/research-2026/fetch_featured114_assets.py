...
urls=['https://herthametals.com/','https://www.hexium.com/','https://hilliary.com/','https://aspirerhs.org/']
a=list(concurrent.futures.ThreadPoolExecutor(5).map(run,urls));(r/'featured114-assets.json').write_text(json.dumps(a,indent=2));print(json.dumps(a,indent=2))
