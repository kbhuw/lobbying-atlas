...
r=pathlib.Path('work/research-2026');rows=json.load(open(r/'general-round93-input.json'));e={};p={}
e=json.load(open(r/'round93-root-incremental-evidence.json'))
...
(r/'general-round93-root-draft.json').write_text(json.dumps(p,indent=2)+'\n')
