...
profiles=json.load(open("work/research-2026/general-round3-90-draft.json"))
with concurrent.futures.ThreadPoolExecutor(max_workers=8) as ex:
 for k,v in ex.map(one,[(k,v) for k,v in profiles.items() if v.get("website") and k in ["e790f78ba0a14e2b","e79f84eff23e23aa","0805610b4f8279b3"]]):print(k,v.get("http_status"),v.get("error",""),flush=True)
