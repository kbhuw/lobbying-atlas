...
r=pathlib.Path('work/research-2026');rows=json.load(open(r/'general-round146-input.json'));e={};p={}
e=json.load(open(r/'round146-root-incremental-evidence.json'))
...
(r/'general-round146-root-draft.json').write_text(json.dumps(p,indent=2)+'\n')
