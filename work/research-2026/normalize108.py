...
r=pathlib.Path('work/research-2026');rows=json.load(open(r/'general-round108-input.json'));e={};p={}
e=json.load(open(r/'round108-root-incremental-evidence.json'))
...
(r/'general-round108-root-draft.json').write_text(json.dumps(p,indent=2)+'\n')
