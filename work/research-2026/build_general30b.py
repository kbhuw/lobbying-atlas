...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round30b-root-draft.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
hold={'b2bb71c3e281865d','68d880b44027b0dd','087b73c2be4de158','f19c35f1531a135e'}
for k,v in p.items():
...
assert len(p)==30
(r/'general-round30b-30-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
