...
r=Path('work/research-2026');p=json.load(open(r/'reviewed.json'));ids=['0626a07c523aaa2d','0ae15afcd4b5fe3f','03a02d290cca0228','0ee7d05f67dd1e9e']
def f(i):
...
(r/'featured189-additional-logo-candidates.json').write_text(json.dumps(out,indent=2));print(json.dumps([{**v,'candidates':[{**a,'url':a['url'][:250]} for a in v.get('candidates',[])]} for v in out],indent=2))
