...
profiles=json.load(open("work/research-2026/general-round8-90-draft.json"))
for k in ["24b8de228d0bf51c","c9b11c735f0490fb","419f6698d5b7b7c7"]:
 key,c=one((k,profiles[k]));print(key,c.get('http_status'),c.get('error',''))
for k,index in [('b950d94acea8eba9',1),('1bbcdadc62014fdf',1),('f9aee15766a7cc9f',1)]:
 ...
 except Exception:c.pop('logo_url',None)
 (cache/(k+'.json')).write_text(json.dumps(c,indent=2));print(k,'asset checked')
