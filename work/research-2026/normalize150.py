...
r=pathlib.Path('work/research-2026');rows=json.load(open(r/'general-round150-input.json'));e={};p={}
e=json.load(open(r/'round150-root-incremental-evidence.json'))
...
(r/'general-round150-root-draft.json').write_text(json.dumps(p,indent=2)+'\n')
