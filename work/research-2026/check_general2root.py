...
profiles=json.load(open("work/research-2026/general-round2-root10.json"))
with concurrent.futures.ThreadPoolExecutor(max_workers=8) as ex:
 for v in ex.map(one,[(k,v) for k,v in profiles.items() if v.get("website")]):print(v,flush=True)
