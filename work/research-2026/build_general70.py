...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round70-root-draft.json'))
rows=json.load(open(r/'general-round70-input.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
allow={7,20,41,42,48,71,1,2,3,4,5,6,8,9,12,13,15,16,17,19,22,23,24,26,29,31,32,33,34,35,36,37,38,39,43,44,45,47,49,50,51,56,57,58,59,60,61,62,63,66,67,68,69,70,72,73,74,75,76,78,81,82,83,86,87,88,89,90,91,93,94,99}
...
assert len(p)==100
(r/'general-round70-100-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
