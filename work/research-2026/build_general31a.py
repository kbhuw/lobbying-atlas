...
r=pathlib.Path('work/research-2026');p=json.load(open(r/'general-round31a-root-draft.json'))
# Hold parent assets where the exact subsidiary branding has not been established.
hold={'e41fb6ce0def99a1','2af6b35d4cf4fa4e','266357fb5266ad04','667ecab17ee1f868','2104b6307dc97e1a','b42cbc75eecb2015','e4bfc3f4a6ad31cc','3a8e2d380d0f204f','9bcf0d6ed47cc42d'}
for k,v in p.items():
...
assert len(p)==30
(r/'general-round31a-30-rootchecked.json').write_text(json.dumps(p,indent=2)+'\n')
