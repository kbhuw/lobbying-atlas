...
profiles=json.load(open("work/research-2026/general-round7-90-draft.json"))
with concurrent.futures.ThreadPoolExecutor(max_workers=8) as ex:
 for k,v in ex.map(one,[(k,v) for k,v in profiles.items() if v.get("website") and k in ["f3219ea81a0b59e8","78a58f16dff73e7d"]]):print(k,v.get("http_status"),v.get("error",""),flush=True)
