...
urls=['https://www.nei.org/','https://ir.nwnaturalholdings.com/','https://go.okstate.edu/about-osu','https://www.nfib.com/','https://ir.newsmax.com/overview/']
def scan(u):
 try:
...
json.dump(out,open('work/research-2026/logo77-candidates.json','w'),indent=2)
