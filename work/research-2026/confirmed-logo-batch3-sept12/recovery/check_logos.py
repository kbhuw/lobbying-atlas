...
b=pathlib.Path('work/research-2026/confirmed-logo-batch3-sept12/recovery');c=b/'logos';c.mkdir(exist_ok=True);d=json.load(open('work/research-2026/reviewed.json'));q=[]
