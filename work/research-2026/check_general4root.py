...
for k,v in [("c0b1399137c4131b",dict(name="Adyton",website="https://www.adytonpbc.com/")),("095bc682cd41ffb0",dict(name="Aeolus",website="https://www.aeolus.earth/"))]:
 _,c=one((k,v));print(k,c.get("http_status"),c.get("error"),c.get("text","")[:8500])
