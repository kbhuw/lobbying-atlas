...
r=pathlib.Path('work/research-2026');rows=json.load(open(r/'general-round68-input.json'));exec((r/'check_general68_final.py').read_text().split('p=json.load(open(root/')[0]);dest=r/'round68-image-audit';dest.mkdir(exist_ok=True)
def fetch(iv):
